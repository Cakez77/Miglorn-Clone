...
const Sprite SPRITES[SPRITE_COUNT] =
{
	...
	[SPRITE_LIGHT_10] = {.atlasOffset={1128, 0}, .size={10, 10}, .pivotOffset={0, 0}, .frameCount=1},
	[SPRITE_LIGHT_32] = {.atlasOffset={912, 0}, .size={32, 32}, .pivotOffset={0, 0}, .frameCount=1},
	[SPRITE_LIGHT_8] = {.atlasOffset={1138, 0}, .size={8, 8}, .pivotOffset={0, 0}, .frameCount=1},
	...
	[SPRITE_WHITE] = {.atlasOffset={1146, 0}, .size={1, 1}, .pivotOffset={0, 0}, .frameCount=1},
